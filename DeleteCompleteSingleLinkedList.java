 ...
 * Date     : 19/11/2024
 * Question : Delete complete SLL.
 */

public class DeleteCompleteSingleLinkedList {

    private Node head;
    private int size;

    public DeleteCompleteSingleLinkedList() {
        head = null;
        size = 0;
    }
    ...
    public static void main(String[] args) {
        ...
        DeleteCompleteSingleLinkedList list = new DeleteCompleteSingleLinkedList();
        list.insertAtEnd(10);
        list.insertAtEnd(20);
        list.insertAtEnd(30);
        list.insertAtEnd(40);
